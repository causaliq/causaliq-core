...
# bad argument types
def test_graph_extend_pdag_type_error():
...
# empty PDAG
def test_graph_extend_pdag_empty_ok():
    pdag = ex_pdag.empty()
    print("\nEmpty PDAG:\n{}".format(pdag))
...
# single node PDAG
def test_graph_extend_pdag_a_ok():
    pdag = ex_pdag.a()
    print("\nSingle node PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# A  B PDAG
def test_graph_extend_pdag_a_b_ok():
    pdag = ex_pdag.a_b()
    print("\nA  B PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# A -> B PDAG
def test_graph_extend_pdag_ab_ok():
    pdag = ex_pdag.ab()
    print("\nA --> B PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# A - B PDAG
def test_graph_extend_pdag_ab3_ok():
    pdag = ex_pdag.ab3()
    print("\nA - B PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# A  B  C PDAG
def test_graph_extend_pdag_a_b_c_ok():
    pdag = ex_pdag.a_b_c()
    print("\nA  B  C PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# A -> B -> C PDAG
def test_graph_extend_pdag_abc_ok():
    pdag = ex_pdag.abc()
    print("\nA -> B -> C PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# A -> C <- B PDAG
def test_graph_extend_pdag_ac_bc_ok():
    pdag = ex_pdag.ac_bc()
    print("\nA -> C -> B PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# A - B - C - A PDAG
def test_graph_extend_pdag_abc_acyclic4_ok():
...
# A -> C   B PDAG
def test_graph_extend_pdag_ac_b_ok():
    pdag = ex_pdag.ac_b()
    print("\nA -> C   B PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
def test_graph_extend_pdag_cancer1_ok():
...
def test_graph_extend_pdag_cancer2_ok():
...
def test_graph_extend_pdag_cancer3_ok():
...
def test_graph_extend_pdag_asia_ok():
    pdag = ex_pdag.asia()
    print("\nFully orientated Asia PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# 1  2  3  4 PDAG
def test_graph_extend_pdag_and4_1_ok():
    pdag = ex_pdag.and4_1()
    print("\n1  2  3  4 PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# 1 - 2  3  4 PDAG
def test_graph_extend_pdag_and4_2_ok():
    pdag = ex_pdag.and4_2()
    print("\n1 - 2  3  4 PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# 1 - 2  3 - 4 PDAG
def test_graph_extend_pdag_and4_3_ok():
    pdag = ex_pdag.and4_3()
    print("\n1 - 2  3 - 4 PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# 1 - 2 - 3  4 PDAG
def test_graph_extend_pdag_and4_4_ok():
    pdag = ex_pdag.and4_4()
    print("\n1 - 2 - 3  4 PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# 1 -> 2 <- 3  4 PDAG
def test_graph_extend_pdag_and4_5_ok():
    pdag = ex_pdag.and4_5()
    print("\n1 -> 2 <- 3  4 PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# 1 - 2 - 3 - 1  4 PDAG
def test_graph_extend_pdag_and4_6_ok():
    pdag = ex_pdag.and4_6()
    print("\n1 - 2 - 3 - 1  4 PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# 1 - 2 - 3 - 4 PDAG
def test_graph_extend_pdag_and4_7_ok():
    pdag = ex_pdag.and4_7()
    print("\n1 - 2 - 3 - 4 PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
# 1 -> 2 <- 3 - 4 PDAG
def test_graph_extend_pdag_and4_8_ok():
    pdag = ex_pdag.and4_8()
    print("\n1 -> 2 <- 3 - 4 PDAG:\n{}".format(pdag))
    dag = extend_pdag(pdag)
    print("\nextended to:\n{}".format(dag))
...
def test_graph_extend_pdag_and4_9_ok():
    pdag = ex_pdag.and4_9()
...
# 1 -> 2 -> 4, 3 -> 2 PDAG
def test_graph_extend_pdag_and4_10_ok():
...
def test_graph_extend_pdag_and4_11_ok():
...
# 2 - 1 - 3 - 2 - 4
def test_graph_extend_pdag_and4_12_ok():
...
# 2 <- 1 - 3 -> 2 <- 4
def test_graph_extend_pdag_and4_13_ok():
...
# 2 <- 1 -> 3 <- 2 <- 4
def test_graph_extend_pdag_and4_14_ok():
...
def test_graph_extend_pdag_and4_15_ok():
...
def test_graph_extend_pdag_and4_16_ok():
...
def test_graph_extend_pdag_and4_17_ok():
...
def test_graph_extend_pdag_and4_inv1_ok():
...
# complete skeleton
def test_graph_extend_pdag_complete4_ok():
