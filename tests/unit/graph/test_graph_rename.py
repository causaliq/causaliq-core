...
# single node PDAG
def test_graph_rename_pdag_a_1_ok():
    graph = ex_pdag.a()
...
# A<--B PDAG
def test_graph_rename_pdag_ba_1_ok():
    graph = ex_pdag.ba()
...
# A--B PDAG
def test_graph_rename_pdag_ab3_1_ok():
    graph = ex_pdag.ab3()
...
# Cancer with 2 undirected edges
def test_graph_rename_pdag_cancer2_1_ok():
    ...
    assert graph.edges == {
        ("Smoker", "LungCancer"): EdgeType.DIRECTED,
...
# Cancer with 2 undirected edges
def test_graph_rename_dag_ac_bc_1_ok():
...
# Asia DAG
def test_graph_rename_dag_asia_1_ok():
