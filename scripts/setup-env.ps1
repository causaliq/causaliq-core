# Comprehensive Python environment management for causaliq-core
# Usage: .\scripts\setup-env.ps1 [options]

param(
    [switch]$Install,           # Install causaliq-core package after creating environments
...
function Show-Help {
    ...
    Write-Host "  -Install         Create environments AND install causaliq-core package" -ForegroundColor White
    Write-Host "  -InstallOnly     Install causaliq-core package in existing environments" -ForegroundColor White
    Write-Host "  -Help            Show this help message" -ForegroundColor White
    Write-Host ""
    Write-Host "EXAMPLES:" -ForegroundColor Yellow
    Write-Host "  .\scripts\setup-env.ps1                    # Create environments only" -ForegroundColor Gray
    Write-Host "  .\scripts\setup-env.ps1 -Install           # Create + install causaliq-core" -ForegroundColor Gray
    Write-Host "  .\scripts\setup-env.ps1 -InstallOnly       # Install causaliq-core in existing envs" -ForegroundColor Gray
    Write-Host ""
...
function Install-InEnvironment {
    ...
    try {
        ...
        Write-Host "  Installing causaliq-core with dev dependencies..." -ForegroundColor Gray
...
if ($InstallOnly) {
    ...
    Write-Host "Installing causaliq-core in all environments..." -ForegroundColor Blue
    ...
    if ($Install) {
        Write-Host "(Will also install causaliq-core package)" -ForegroundColor Gray
    }
...
if (-not ($Install -or $InstallOnly)) {
    Write-Host "To install causaliq-core in all environments:" -ForegroundColor White
