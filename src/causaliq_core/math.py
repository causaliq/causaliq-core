"""
Mathematical utility functions for CausalIQ Core.

This module provides mathematical utility functions commonly used across
the CausalIQ ecosystem, including numeric formatting and logarithm
calculations.
"""
...
def rndsf(
    x: Union[float, int], sf: int, zero: Union[float, None] = None
) -> str:
    """
    ...
    Args:
        x: Number to round
        sf: Number of significant figures required (2-10)
        zero: Absolute values below this treated as zero.
              If None, defaults to 10**(-sf)

    Returns:
        Rounded value as a string formatted to the specified significant
        figures
